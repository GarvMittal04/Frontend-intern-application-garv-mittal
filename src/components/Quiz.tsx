...
export const Quiz = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Best of Luck mascot - bottom left of card (only on first question) */}
        {currentQuestion === 0 && (
          <div className="absolute -bottom-8 left-4 z-10 hidden md:flex items-end">
            {/* Best of Luck speech bubble - positioned above and to the left of paw */}
        ...
        <div className="w-full bg-card/95 backdrop-blur-sm rounded-2xl border border-quiz-card-border shadow-xl p-6 md:p-12">
          ...
          <div className="flex gap-2 mb-8 justify-center">
            {questions.map((_, index) => (
              <div
                key={index}
                className={`h-1.5 w-16 md:w-24 rounded-full transition-colors ${
              ...
              {question.options.map((option, index) => {
                ...
                return (
                  <Label
                    ...
                    className={`flex items-center justify-center p-4 md:p-5 cursor-pointer rounded-lg transition-all ${
                      !isSelected ? "bg-secondary/60 hover:bg-secondary" : ""
                    }`}
                  ...
                  >
                    ...
                    />
                    <span
                      className={`text-center text-foreground transition-colors ${
